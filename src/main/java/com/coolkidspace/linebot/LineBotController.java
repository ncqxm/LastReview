    ...
    public String getTypeMovie(String replyToken, Event event, TextMessageContent content) {
        ...
        if (work == true) {
            if ((text.equals("m1")) || (text.equals("M1"))) {
                ...
                this.reply(replyToken, Arrays.asList(new TextMessage("คุณเลือก\tm5\tHunter killer"),
                        new TextMessage(
                ...
                this.reply(replyToken, Arrays.asList(new TextMessage("คุณเลือก\tm6\tThe old guard"),
                        new TextMessage(
                ...
                this.reply(replyToken, Arrays.asList(new TextMessage("คุณเลือก\tm7\tPee nak 3(พี่นาค3)"),
                        new TextMessage(
                ...
                this.reply(replyToken, Arrays.asList(new TextMessage("คุณเลือก\tm8\tJade dynasty"),
                        new TextMessage(
                ...
                this.reply(replyToken, Arrays.asList(new TextMessage("คุณเลือก\tm9\tBlack crab"),
                        new TextMessage(
                ...
                this.reply(replyToken, Arrays.asList(new TextMessage("คุณเลือก\tm10\tGet him girl(ส้มป่อย)"),
                        new TextMessage(
            ...
            // ซีรีส์---------------------------------------------
                ...
                this.reply(replyToken, Arrays.asList(new TextMessage("คุณเลือก\ts1\tBusiness Proposal"),
                        new TextMessage(
                ...
                this.reply(replyToken, Arrays.asList(new TextMessage("คุณเลือก\ts2\ttwenty five twenty one"),
                        new TextMessage(
                ...
                this.reply(replyToken, Arrays.asList(new TextMessage("คุณเลือก\ts3\tForecasting Love and Weather"),
                        new TextMessage(
                ...
                this.reply(replyToken, Arrays.asList(new TextMessage("คุณเลือก\ts4\tAll of Us Are Dead"),
                        new TextMessage(
                ...
                this.reply(replyToken, Arrays.asList(new TextMessage("คุณเลือก\ts5\tMy Roommate is a Gumiho"),
                        new TextMessage(
                ...
                this.reply(replyToken, Arrays.asList(new TextMessage("คุณเลือก\ts6\tJuvenile Justice"),
                        new TextMessage(
                ...
                this.reply(replyToken, Arrays.asList(new TextMessage("คุณเลือก\ts7\tThe Silent Sea ทะเลสงัด"),
                        new TextMessage(
                ...
                this.reply(replyToken, Arrays.asList(new TextMessage("คุณเลือก\ts8\tThe Cursed"),
                        new TextMessage(
                ...
                this.reply(replyToken, Arrays.asList(new TextMessage("คุณเลือก\ts9\tCracow Monsters"),
                        new TextMessage(
                ...
                this.reply(replyToken, Arrays.asList(new TextMessage("คุณเลือก\ts10\tEmily in Paris season 2"),
                        new TextMessage(
                                " "),
                        new TextMessage("รีวิวแบบเต็มค่ะ : "),
                        new TextMessage("Trailer : ")));
